        ...
        <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-auto">
            <defs>
                <linearGradient id="barGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%"   stopColor="var(--chart-bar-hi,  #7ee0ff)" />
                    <stop offset="55%"  stopColor="var(--chart-bar-mid, #38bdf8)" />
                    <stop offset="100%" stopColor="var(--chart-bar-lo,  #1f96cf)" />
                </linearGradient>
            </defs>
            {data.map((d, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        <text x={x + barW / 2} y={y - 6} textAnchor="middle" fontSize="11" fill="var(--chart-label-hi, #e6edf4)" fontWeight="600">
                            {fmt(d.value)}
                        </text>
                        <text x={x + barW / 2} y={height - 10} textAnchor="middle" fontSize="11" fill="var(--chart-label-lo, #7e8c9a)">
                            {d.label}
                        </text>
                    </g>
                )
